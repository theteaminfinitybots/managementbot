...
if ENV:
    ...
    DB_URI = os.getenv("DATABASE_URL", "sqlite:///alonerobot.db")
    ...
    SUPPORT_CHAT = os.environ.get("SUPPORT_CHAT", "https://t.me/NOB1TA_SUPPORT")
    ...
    try:
        ...
        DEV_USERS = set(int(x) for x in os.environ.get("DEV_USERS", "5536473064").split())
    except ValueError:
